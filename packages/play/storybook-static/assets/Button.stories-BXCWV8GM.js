import{e as U,c as V,_ as Q,B as A,f as Z,w as F,s as c,u,a as r,b as l}from"./index-B-tvywwQ.js";import{d as q,b as tt,u as et,e as nt,f as p,o as h,g as _,n as at,j as ot,k as st,p as ut,r as rt,t as k,l as ct,m as f,w as lt,q as it,s as z,v as Y}from"./vue.esm-bundler-CzGIvhYB.js";import"./index-Bqoxw6Vv.js";const K=Symbol("BUTTON_GROUP_CTX_KEY"),pt=U(q({name:"YoButton",__name:"Button",props:{tag:{default:"button"},type:{},size:{},nativeType:{default:"button"},disabled:{type:Boolean},loading:{type:Boolean},loadingIcon:{},icon:{},circle:{type:Boolean},plain:{type:Boolean},round:{type:Boolean},autofocus:{type:Boolean},useThrottle:{type:Boolean,default:!0},throttleDuration:{default:500}},emits:["click"],setup(t,{expose:e,emit:o}){const a=t,s=tt(K,void 0),X=o,J=et(),w=nt(),v=p(()=>(s==null?void 0:s.size)??(a==null?void 0:a.size)??""),m=p(()=>(s==null?void 0:s.type)??(a==null?void 0:a.type)??""),C=p(()=>(s==null?void 0:s.disabled)||(a==null?void 0:a.disabled)||!1),E=p(()=>({marginRight:J.default?"6px":"0px"})),T=n=>X("click",n),L=Q(T,a.throttleDuration,{trailing:!1});return e({ref:w,disabled:C,size:v,type:m}),(n,x)=>(h(),_(st(n.tag),{ref_key:"_ref",ref:w,class:at(["yo-button",{[`yo-button--${m.value}`]:m.value,[`yo-button--${v.value}`]:v.value,"is-plain":n.plain,"is-round":n.round,"is-circle":n.circle,"is-disabled":C.value,"is-loading":n.loading}]),autofocus:n.autofocus,type:n.tag==="button"?n.nativeType:void 0,disabled:!(!C.value&&!n.loading)||void 0,onClick:x[0]||(x[0]=D=>n.useThrottle?ot(L)(D):T(D))},{default:lt(()=>[n.loading?f(n.$slots,"loading",{key:0},()=>[it(A,{class:"loading-icon",icon:n.loadingIcon??"spinner",style:z(E.value),spin:""},null,8,["icon","style"])],!0):Y("",!0),n.icon&&!n.loading?(h(),_(A,{key:1,icon:n.icon,style:z(E.value),size:"1x"},null,8,["icon","style"])):Y("",!0),f(n.$slots,"default",{},void 0,!0)]),_:3},8,["autofocus","type","disabled","class"]))}}),[["__scopeId","data-v-b8b5f604"]]),dt={class:"yo-button-group"},yt=U(q({name:"YoButtonGroup",__name:"ButtonGroup",props:{size:{},type:{},disabled:{type:Boolean}},setup(t){const e=t;return ut(K,rt({size:k(e,"size"),type:k(e,"type"),disabled:k(e,"disabled")})),(o,a)=>(h(),ct("div",dt,[f(o.$slots,"default",{},void 0,!0)]))}}),[["__scopeId","data-v-d1d689b8"]]),i=V(pt),bt=V(yt),mt={title:"Components/Button",component:i,tags:["autodocs"],argTypes:{type:{control:{type:"select"},options:["primary","success","warning","danger","info"]},size:{control:{type:"select"},options:["small","medium","large"]},disabled:{control:{type:"boolean"}},loading:{control:{type:"boolean"}},useThrottle:{control:{type:"boolean"}},throttleDuration:{control:{type:"number"}},autofocus:{control:{type:"boolean"}},tag:{control:{type:"text"}},nativeType:{control:{type:"select"},options:["button","submit","reset"]},icon:{control:{type:"text"}},loadingIcon:{control:{type:"text"}},plain:{control:{type:"boolean"}},round:{control:{type:"boolean"}},circle:{control:{type:"boolean"}}},args:{onClick:Z()}},B=t=>`
...
`,d={argTypes:{content:{control:{type:"text"}}},args:{type:"primary",content:"Button"},render:t=>({components:{YoButton:i},setup(){return{args:t}},template:B(`
      <yo-button data-testid="story-test-btn" :type="args.type" v-bind="args">
        {{ args.content }}
      </yo-button>`)}),play:async({canvasElement:t,args:e,step:o})=>{const s=F(t).getByTestId("story-test-btn");await o("When useThrottl is set be true, the conClick can be called once",async()=>{c(e,"useThrottle",!0),await u.tripleClick(s),r(e.onClick).toHaveBeenCalledOnce(),l()}),await o("When useThrottl is set be false, the conClick can be called three times",async()=>{c(e,"useThrottle",!1),await u.tripleClick(s),r(e.onClick).toHaveBeenCalledTimes(3),l()}),await o("When disabled is set be true, the conClick can not be called",async()=>{c(e,"disabled",!0),await u.click(s),r(e.onClick).toHaveBeenCalledTimes(0),c(e,"disabled",!1),l()}),await o("When loading is set be true, the onClick can not be called",async()=>{c(e,"loading",!0),await u.click(s),r(e.onClick).toHaveBeenCalledTimes(0),c(e,"loading",!1),l()})}},y={argTypes:{content:{control:{type:"text"}}},args:{content:"Button",autofocus:!0},render:t=>({components:{YoButton:i},setup(){return{args:t}},template:B(`
    ...
    `)}),play:async({canvasElement:t,args:e,step:o})=>{const a=F(t);await o("click btn1",async()=>{await u.click(a.getByText("Button1"))}),await o("click btn2",async()=>{await u.click(a.getByText("Button2"))}),await o("click btn3",async()=>{await u.click(a.getByText("Button3"))}),r(e.onClick).toHaveBeenCalled()}};var H,S,I;d.parameters={...d.parameters,docs:{...(H=d.parameters)==null?void 0:H.docs,source:{originalSource:`{
  argTypes: {
    content: {
      control: {
        type: 'text'
